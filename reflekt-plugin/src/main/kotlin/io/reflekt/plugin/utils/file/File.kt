package io.reflekt.plugin.utils.file
...
object FileUtil {
    ...
    fun List<File>.toKotlinFilesSet(extensions: List<String>): Set<File> = this.filter { it.isKotlinFile(sourceFilesExtensions = extensions) }.toSet()
