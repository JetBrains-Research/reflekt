...
fun main() {
    ...
    fooWithType<MyType>("MyType (org.jetbrains.reflekt.plugin.ir.type.types.MyType)")
    ...
    fooWithType<MyEnumType>("MyEnumType (org.jetbrains.reflekt.plugin.ir.type.types.MyEnumType)")
}
